...
//let nombreVariable = "pepe";
//console.log("nombre variable es: "+ nombreVariable);
...
//let nombremio = "manu"
//let edad = 28
//console.log("mi nombre es: "+ nombremio + " y mi edad es: "+edad);
...
//    return numero1 - numero2;
//}
//console.log(sumar(10,139));
//console.log(restar(10,139));
...
// function calEdad(añonas){

//    return 2024 - añonas

// let nacimiento = Number(prompt ("ingrese su año de nacimiento: "))

// console.log("su edad es de: " + calEdad(nacimiento))
...
if (tieneDocumento === "si") {
    ...
    if (edad >= 18) {
        ...
        console.log("No puede entrar al bar, es menor de edad");
    }
} else if (tieneDocumento === "no") {
    console.log("Disculpe, sin documento no puede ingresar");
}
